...
public final class IntervalTreeBDemo3
{
  private static final Logger LOG =
    LoggerFactory.getLogger(IntervalTreeBDemo3.class);

  private IntervalTreeBDemo3()
  {
    ...
    throws Exception
  {
    ...
    t.setChangeListener(change -> {
      LOG.debug("Change: {}", change);
      try {
        dot(t, count.getAndIncrement());
